...
function buildDashboardSystemPrompt(
  ...
  lines.push(
    ...
    " 2. Start by listing headlines for the selected sectors when the question is broad; drill into get_news_details / fetch_article only for items the user is actually asking about.",
    ...
    " 7. If a question genuinely needs article body text (fact extraction, specific numbers, quotes), call fetch_article — but only for the items that matter.",
    "",
  );
